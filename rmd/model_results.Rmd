...
# actually we want to present the marginal effect - todo

forest_plot(msm_model_3, table = TRUE, covars = "months_since_pos:vaccine_short") |>
    mutate(
        est = 1 - est,
        lower = 1 - lower,
        upper = 1 - upper,
...
p1 <- forest_plot(msm_model_4, table = TRUE, transition2 = "State 1 - State 3", covars = "vaccine_short") |>
    mutate(
        est = 1 - est,
        lower = 1 - lower,
        upper = 1 - upper,
...
p2 <- forest_plot(msm_model_5, table = TRUE, transition2 = "State 1 - State 3", covars = "vaccine") |>
    mutate(
        est = 1 - est,
        lower = 1 - lower,
        upper = 1 - upper,
...
p3 <- forest_plot(mmsvrahgo_sym, table = TRUE, transition2 = "State 1 - State 3", covars = "months_since_pos") |>
    mutate(
        est = 1 - est,
        lower = 1 - lower,
        upper = 1 - upper,
...
diagnostics <- model_results(mmllvrahgo_noev,
    dataset = siren_df,
    mintime = 0,
    timezero = 0,
...
sojourn.msm(msvag_just_rev)$estimates[2] * 7
sojourn.msm(msvag_just_rev)$L[2] * 7
sojourn.msm(msvag_just_rev)$U[2] * 7

sojourn.msm(mmsvag_sym_rev)
